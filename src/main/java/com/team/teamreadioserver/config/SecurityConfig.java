...
//              .and() (삭제) 람다식에선 필요없음
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/users/login", "/users/join/**","/users/account/**", "/users/sendCode", "/users/verifyUser", "/users/resetPassword", "/video/**", "/curation/**", "/img/**", "/search/**", "/bookPage/**", "/bookReview/**", "/reported/**", "/serviceCenter/**", "/videoBookmark/publicCount/**","/api/clicks/**").permitAll()  // 인증 필요없는 경로
