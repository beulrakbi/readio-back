...
//
//    // 디버깅용 로거 사용
//    private static final Logger logger = LoggerFactory.getLogger(JwtAuthenticationFilter2.class);
//
//    public JwtAuthenticationFilter2(JwtTokenProvider tokenProvider, CustomUserDetailsService userDetailsService) {
